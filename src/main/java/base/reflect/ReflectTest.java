...
//        try{
//            Class<?> clz = Class.forName("base.reflect.ReflectDemo");
...
//        }
    ...
    private Class<?> getClass(String type){
        if("class".equals(type)){
            ...
            try{
                return Class.forName("base.reflect.ReflectDemo");
            }catch (Exception e){
    ...
    private void getClassName(){
        ...
        System.out.println(clazz.getName());// base.reflect.ReflectDemo
    ...
    public void testClassLoader1() {
        ...
        try {
            ...
            classLoader = Class.forName("base.reflect.ReflectDemo").getClassLoader();
