...
public class XmlSpreadsheetSAXHandler extends DefaultHandler {
	...
	public XmlSpreadsheetSAXHandler() {
	}
	...
	public void parse(String uri, String localName, String qName, Attributes attributes) {
		...
		} else if (XmlSpreadsheetConstants.QNAME_B.equals(qName) || XmlSpreadsheetConstants.QNAME_I.equals(qName)
			|| XmlSpreadsheetConstants.QNAME_S.equals(qName) || XmlSpreadsheetConstants.QNAME_U.equals(qName)) {
			converter.parseRichTextFontStyle(record);
		}
	}
	...
	private XmlSpreadsheetNode buildNode(String uri, String localName, String qName, Attributes attributes) {
